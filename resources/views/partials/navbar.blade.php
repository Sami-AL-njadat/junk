    ...
    <div class="titan-container">
        <div class="d-flex align-items-center justify-content-between">
            <a href="{{ url('/') }}#" class="d-flex align-items-center gap-3 text-decoration-none text-reset">
                <div class="logo-box industrial-clip d-flex align-items-center justify-content-center overflow-hidden flex-shrink-0">
                    @include('partials.titan-logo', ['class' => 'w-100 h-100 object-fit-contain p-1', 'width' => 48, 'height' => 48])
                </div>
            ...
            <nav class="d-none d-md-flex align-items-center titan-nav-links">
            ...
            <div class="d-flex align-items-center gap-2">
                <button
                    type="button"
                    class="btn-theme-cycle d-inline-flex align-items-center gap-1"
                    data-theme-cycle
                ...
                <a href="tel:+13313414878" class="btn-titan-call btn-titan-call-nav industrial-clip d-none d-sm-inline-flex align-items-center gap-2 text-decoration-none box-glow">
                    <i class="bi bi-telephone-fill"></i>
                    <span>(331) 341-4878</span>
                </a>

                <button
                    class="btn btn-link text-foreground d-md-none p-2"
                    type="button"
                    data-bs-toggle="offcanvas"
                    data-bs-target="#titanMobileNav"
                    aria-controls="titanMobileNav"
...
<div class="offcanvas offcanvas-end offcanvas-titan text-foreground" tabindex="-1" id="titanMobileNav" aria-labelledby="titanMobileNavLabel">
    ...
    <div class="offcanvas-body d-flex flex-column align-items-center justify-content-center gap-4 py-5">
        <a href="#how-it-works" class="font-display fs-3 fw-bold text-decoration-none text-foreground" data-bs-dismiss="offcanvas">How It Works</a>
        <a href="#why-us" class="font-display fs-3 fw-bold text-decoration-none text-foreground" data-bs-dismiss="offcanvas">Why Us</a>
        <a href="#service-area" class="font-display fs-3 fw-bold text-decoration-none text-foreground" data-bs-dismiss="offcanvas">Service Area</a>
        <hr class="w-75 border-titan opacity-100">
        <a href="tel:+13313414878" class="btn-titan-call industrial-clip w-100 d-flex align-items-center justify-content-center gap-2 py-3 fs-5 text-decoration-none box-glow" data-bs-dismiss="offcanvas">
